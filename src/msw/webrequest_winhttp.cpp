...
{
    int resolveTimeoutMs = m_connectionTimeoutMs == wxWebRequest::DefaultTimeout ?
        WINHTTP_DEFAULT_RESOLVE_TIMEOUT : m_connectionTimeoutMs;
    int connectionTimeoutMs = m_connectionTimeoutMs == wxWebRequest::DefaultTimeout ?
        WINHTTP_DEFAULT_CONNECT_TIMEOUT : m_connectionTimeoutMs;
    int dataTimeoutMs = m_dataTimeoutMs == wxWebRequestWinHTTP::DefaultTimeout ?
